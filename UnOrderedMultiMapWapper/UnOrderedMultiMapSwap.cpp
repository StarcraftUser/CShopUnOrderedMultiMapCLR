...
{
	if (Object::ReferenceEquals(OtherCSharpUnOrderedMultiMap, nullptr)) return;

	if (nKeyValueType != OtherCSharpUnOrderedMultiMap->nKeyValueType) return;
	...
	if (gIntKeyClassDictionary && OtherCSharpUnOrderedMultiMap->gIntKeyClassDictionary)
	{
		...
		gIntKeyClassDictionary = OtherCSharpUnOrderedMultiMap->gIntKeyClassDictionary;
		OtherCSharpUnOrderedMultiMap->gIntKeyClassDictionary = temp;
		...
		OtherCSharpUnOrderedMultiMap->multiNode->SetIntKeyClassDictionary(OtherCSharpUnOrderedMultiMap->gIntKeyClassDictionary);
		OtherCSharpUnOrderedMultiMap->KeyEndNode->SetIntKeyClassDictionary(OtherCSharpUnOrderedMultiMap->gIntKeyClassDictionary);
		OtherCSharpUnOrderedMultiMap->RIterNode->SetIntKeyClassDictionary(OtherCSharpUnOrderedMultiMap->gIntKeyClassDictionary);
	}
}
